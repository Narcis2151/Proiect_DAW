...
namespace Proiect_DAW.Data.Migrations
{
    ...
    [Migration("20221203182728_Create_Friendships")]
    partial class Create_Friendships
    {
            ...
            modelBuilder.Entity("ApplicationUserFriendship", b =>
                {
                    ...
                    b.Property<int>("FriendshipsReveivedId")
                        .HasColumnType("int");

                    b.HasKey("AdreseesId", "FriendshipsReveivedId");

                    b.HasIndex("FriendshipsReveivedId");

                    b.ToTable("ApplicationUserFriendship");
                });

            modelBuilder.Entity("ApplicationUserFriendship1", b =>
                {
                    b.Property<int>("FriendshipsSentId")
                        .HasColumnType("int");

                    b.Property<string>("RequestersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("FriendshipsSentId", "RequestersId");

                    b.HasIndex("RequestersId");

                    b.ToTable("ApplicationUserFriendship1");
                });
            ...
            modelBuilder.Entity("ApplicationUserFriendship", b =>
                {
                    ...
                    b.HasOne("Proiect_DAW.Models.Friendship", null)
                        .WithMany()
                        .HasForeignKey("FriendshipsReveivedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ApplicationUserFriendship1", b =>
                {
                    b.HasOne("Proiect_DAW.Models.Friendship", null)
                        .WithMany()
                        .HasForeignKey("FriendshipsSentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
